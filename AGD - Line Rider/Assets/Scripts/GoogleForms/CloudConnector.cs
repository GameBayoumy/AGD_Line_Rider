...
public class CloudConnector : MonoBehaviour
{
	...
	private string spreadsheetId = "101qLkGaaSyg8ekrWcyVGNIMaHgztsgIaitmC2udh4mM"; // If this is a fixed value could also be setup on the webservice to save POST request size.
